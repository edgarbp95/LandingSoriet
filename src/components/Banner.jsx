  ...
  return (
    ...
    <div className='pt-8 pb-10 sm:pb-4 w-full py-10 px-20 mx-auto flex justify-center sm:flex-col sm:px-0'>
      ...
      <div className='w-2/4 flex flex-col gap-1 sm:gap-3 justify-center relative sm:w-full sm:px-4 sm:text-justify'>
        ...
        <p className='text-base text-gray-700 w-11/12 mt-2 sm:text-sm sm:w-full'>Contamos con diseño especializado para páginas webs, redes sociales, logotipos, y mucho más. Contáctanos y refuerza la identidad de tu empresa a los mejores precios del mercado.</p>
